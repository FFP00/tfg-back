...
def upgrade():
    t = op.create_table("wallet",
        ...
        Column("customer_user_id",  Integer, ForeignKey("customer.user_id"), primary_key=True, nullable=False),

        Column("balance",           Numeric(precision=5, scale=2), nullable=True),
    ...
    op.execute("""
        ...
        RETURNS TRIGGER AS $$
        BEGIN
            INSERT INTO wallet (customer_user_id, balance)
