...
from app.config.session import AdminSessionMiddleware
...
from app.endpoint.routes.stripeRoute import router as stripe_router
...
from app.endpoint.views.loginView import router as login_view_router
...
app.include_router(login_view_router,       prefix="/views/login",        tags=["Views"])
...
app.include_router(token_view_router,       prefix="/views/token",        tags=["Views"])
